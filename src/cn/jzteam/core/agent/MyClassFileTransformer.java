...
public class MyClassFileTransformer implements ClassFileTransformer {
    ...
    public byte[] transform(ClassLoader loader, String className, Class<?> classBeingRedefined, ProtectionDomain protectionDomain, byte[] classfileBuffer) throws IllegalClassFormatException {
        ...
        try {
            if (className == null || "".equals(className) || !className.contains("UserKycInfoCommonServiceImpl")) {
                return null;
            }
            System.out.println("---- 处理 UserKycInfoCommonServiceImpl getIdCardRealNameByUserId 方法 -----");
            ...
            for (CtBehavior method : methods) {
                ...
                if ("getIdCardRealNameByUserId".equals(methodName)) {
