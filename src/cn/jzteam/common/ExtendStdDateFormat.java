...
public class ExtendStdDateFormat extends DateFormat {
    /*
     * TODO !!! 24-Nov-2009, tatu: Need to rewrite this class soon: JDK date
     * parsing is awfully brittle, and ISO-8601 is quite permissive. The two
     * don't mix, need to write a better one.
     */
    ...
    final static String DATA_FORMAT_STR_TIME = "yyyy-MM-dd HH:mm:ss";

    /**
     * For error messages we'll also need a list of all formats.
     */
    final static String[] ALL_FORMATS = new String[] { DATE_FORMAT_STR_ISO8601, DATE_FORMAT_STR_ISO8601_Z,
            DATE_FORMAT_STR_RFC1123, DATE_FORMAT_STR_PLAIN, DATA_FORMAT_STR_TIME };
    ...
    final static SimpleDateFormat DATA_FORMAT_TIME;
    ...
    static {
        ...
        DATA_FORMAT_TIME = new SimpleDateFormat(DATA_FORMAT_STR_TIME);
        DATA_FORMAT_TIME.setTimeZone(gmt);
    }

    /**
     * A singleton instance can be used for cloning purposes.
     */
    public final static ExtendStdDateFormat instance = new ExtendStdDateFormat();
    ...
    transient SimpleDateFormat _formatTime;
    ...
    public ExtendStdDateFormat() {
    }

    @Override
    public ExtendStdDateFormat clone() {
        /*
         * Since we always delegate all work to child DateFormat instances,
         * let's NOT call super.clone(); this is bit unusual, but makes sense
         * here to avoid unnecessary work.
         */
        return new ExtendStdDateFormat();
    }
    ...
    public Date parse(String dateStr) throws ParseException {
        ...
        throw new ParseException(String.format(
                "Can not parse date \"%s\": not compatible with any of standard forms (%s)", dateStr, sb.toString()),
                pos.getErrorIndex());
    }
    ...
    protected Date parseAsISO8601(String dateStr, ParsePosition pos) {
        ...
        if (len <= 10 && Character.isDigit(c)) {
            ...
            df = _formatTime;
            if (df == null) {
                df = _formatTime = (SimpleDateFormat) DATA_FORMAT_TIME.clone();
            }
        } else if (c == 'Z') {
            df = _formatISO8601_z;
            if (df == null) {
            ...
            if (hasTimeZone(dateStr)) {
                ...
                // [JACKSON-334]: may be missing milliseconds... if so, add
                len = dateStr.length();
                // '+0000' (5 chars); should come after '.000' (4 chars) of
                // milliseconds, so:
                ...
                /*
                 * 24-Nov-2009, tatu: Ugh. This is getting pretty ugly. Need to
                 * rewrite soon!
                 */
